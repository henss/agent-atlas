...
- Package publishing remains out of scope until a separate distribution decision. Before a preview `@agent-atlas/cli` release, run the readiness checklist in `docs/guides/package-publish-readiness.md`.
